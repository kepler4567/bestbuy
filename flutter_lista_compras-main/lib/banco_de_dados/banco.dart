...
class SQLDatabase {
  ...
  static _creatingDb(db) async {
    await db.execute(
        'CREATE TABLE IF NOT EXISTS conta (id INTEGER PRIMARY KEY, user_id INTEGER, titulo TEXT, quantidade INTEGER, descricao TEXT, FOREIGN KEY (user_id) REFERENCES users(id))');
    await db.execute(
